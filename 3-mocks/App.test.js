...
it('Lists the names and usernames of the users', async () => {
  ...
  expect(await screen.findByText(/Gøran - gorbas/)).toBeInTheDocument()
  expect(await screen.findByText(/Sigve - siggod/)).toBeInTheDocument()
  expect(await screen.findByText(/Frode - frowar/)).toBeInTheDocument()
})
